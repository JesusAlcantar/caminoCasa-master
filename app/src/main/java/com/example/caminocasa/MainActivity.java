...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new OverlayItem("Title", "Description", new GeoPoint(20.17466694622346,
...
//add your points here
    ...
    private void obtenerRouteFromMapRequest(Double latitud, Double longitud){
        System.out.println("http://www.mapquestapi.com/directions/v2/route?key=EwNXPABPnLR6R250CknmVJPk8ZGaFnqp&from="+latitud+","+longitud+"&to=20.174671981510677, -100.99771137323822");
        ...
        requestMapRequest =
                new JsonObjectRequest(
                        ...
                        "http://www.mapquestapi.com/directions/v2/route?key=EwNXPABPnLR6R250CknmVJPk8ZGaFnqp&from="+latitud+","+longitud+"&to=20.174671981510677, -100.99771137323822",
